                            ...
                            (
                                filterDataTypeClient?.map((item)=>(
                                    <TableRow key={item?.id_cliente}>
                                        ...
                                        <TableCell>
                                            <ul>
                                                {Array.from({length: item?.puntuacion}, (_, i) => (
                                                    <li key={i} className="inline-block text-yellow-400"><Star/></li>
                                                ))}
                                            </ul>
                                        </TableCell>
                                        <TableCell>
                                            <p className={cn('p-2 rounded-lg text-azulOscuro text-center', typesClient?.filter((type)=>type?.value === item?.isactive)[0].className)}>{typesClient?.filter((type)=>type?.value === item?.isactive)[0]?.name}</p>
                                        </TableCell>
                                        <TableCell>
                                            <Popover>
                                                ...
                                                <PopoverContent className="w-fit p-2" >
                                                    <div className='w-fit flex flex-col '>
                                                        ...
                                                        <Button 
                                                            ...
                                                            onClick={()=>handleDeleteClient(item?.id_cliente)}    
                                                        >
                                                            <p>Eliminar</p><Trash/>
                                                        </Button>
                                                    </div>
